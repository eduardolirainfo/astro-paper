...
export default function SearchBar({ searchList }: Props) {
  ...
  return (
    <>
      <label className="focus relative m-4 block rounded-full   from-indigo-700 via-blue-500 to-cyan-400 p-1 focus-within:bg-gradient-to-r hover:bg-gradient-to-r">
        ...
        <input
          className="block w-full rounded-full border border-skin-fill 
